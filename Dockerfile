# This dockerfile uses extends image https://hub.docker.com/sinlov-go/sembed
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov-go/sembed
ARG GO_ENV_ROOT_BUILD_BIN_NAME=sembed
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/sembed/main.go
